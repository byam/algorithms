...
void solve() {
    ...
    // yymm
    if (s[2] - '0' > 1) yymm = false;
    if (s[2] - '0' == 1 and s[3] - '0' > 2) yymm = false;
    if (s[2] - '0' == 0 and s[3] - '0' == 0) yymm = false;

    // mmyy
    if (s[0] - '0' > 1) mmyy = false;
    if (s[0] - '0' == 1 and s[1] - '0' > 2) mmyy = false;
    if (s[0] - '0' == 0 and s[1] - '0' == 0) mmyy = false;
